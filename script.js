...
document.getElementById('mm-cart-plus').innerText= ' ' +cartData.length;
...
tableBody.appendChild(tableRow);
    ...
    document.getElementById('offer').addEventListener('click',offerToggle);

    function offerToggle(){
        document.getElementById('offer-up').classList.toggle('offer-up');
    }
    ...
    document.getElementById('mm-add-address').addEventListener('click',addAddress);
...
document.getElementById('add-search').addEventListener('click',addSearch);
document.getElementById('m-add-search').addEventListener('click',addSearch);
...
document.getElementById('m-add-search').innerText= ' Search';
...
document.getElementById('Helpline').addEventListener('click',helpLine);

function helpLine(){
var help=prompt('Enter your complaint')
if (help) {
    alert('call HelpLine 04424912434')
